...
WITH ranked AS (
	SELECT
		...
		i.number, i.project_id, i.module_id, i.metadata, i.stage, i.properties, i.revision, i.duplicate_of_issue_id,
...
SELECT
	...
	number, project_id, module_id, metadata, stage, properties, revision, duplicate_of_issue_id, group_total
FROM ranked
