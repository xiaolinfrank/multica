...
func TestIsSuppressedRecipient(t *testing.T) {
	tests := []struct {
		...
		{"upstream vendor domain", "integration-sendcode@multica.ai", true},
		{"upstream vendor domain, invite fixture", "invitation-test@multica.ai", true},
		{"mdns tld", "cooldown-probe@test.local", true},
		...
		{"vendor subdomain passes", "someone@mail.multica.ai", false},
