...
export default function SkillsPage() {
  ...
  // List request error — rendered inside the Workspace tab body. Deliberately a
  // variable rather than upstream's early return: returning here unmounts the
  // page header and the tab strip, which makes the Runtime tab unreachable
  // whenever the workspace skill list fails to load.
  const listErrorView = (
    <CollectionPageState
      role="alert"
      tone="destructive"
