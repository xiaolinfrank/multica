...
// One function, two names: fork-side tests talk to `mocks.createProject`
// while upstream's ref tests talk to `createProjectMock`.
vi.hoisted(() => {
  mocks.createProject = createProjectMock;
});
