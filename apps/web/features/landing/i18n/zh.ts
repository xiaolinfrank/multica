...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    imageAlt: "BayClaw \\u770b\\u677f\\u89c6\\u56fe\\u2014\\u2014\\u4eba\\u7c7b\\u548c 智能体 \\u534f\\u540c\\u7ba1\\u7406\\u4efb\\u52a1",
  },
  ...
  about: {
    ...
    paragraphs: [
      ...
      "在 BayClaw 中，agents 是一级团队成员。它们会被分配任务，汇报进展，提出阻塞，并交付代码，就像人类同事一样。任务分配、活动时间线、task 生命周期，以及运行时基础设施，BayClaw 从第一天起就是围绕这一理念构建的。",
  ...
  changelog: {
    ...
    entries: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Slack 里可以直接用原生 /issue 斜杠命令创建 BayClaw 任务，机器人只会向你私发一条包含任务链接的确认消息。",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "BayClaw iOS 客户端发布官方首个可用版本，覆盖登录、工作区、收件箱、任务、项目、聊天、评论、表情回应、在线状态和实时更新；目前暂未上架 App Store，需要用户自行打包安装",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "接入 GitHub 后，关联的 Pull Request 会显示在 BayClaw 任务中，状态会同步到 BayClaw，关闭 PR 后会自动关闭对应任务",
          "聊天消息支持添加文件附件和图片预览",
