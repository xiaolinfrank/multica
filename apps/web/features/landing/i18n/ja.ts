...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      talkToSales: "営業に相談する",
      worksWith: "対応ツール",
      imageAlt: "人間と AI エージェントがタスクを管理する BayClaw のボード画面",
    },
    features: {
      teammates: {
        label: "チームメイト",
      ...
      autonomous: {
        ...
        description:
          "一往復で終わる指示ではありません。作業をキューに入れ、受け取り、開始し、完了または失敗まで報告する。このライフサイクル全体を BayClaw が管理します。詰まったところはエージェントが先に知らせ、進捗は WebSocket でリアルタイムに届きます。",
        cards: [
          {
            title: "最初から最後まで追跡",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "BayClaw は Antigravity、Claude Code、CodeBuddy、CodeArts、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、MiniMax Code、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI、ZeroClaw という26種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。BayClaw はその上に、作業キュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間の作業を自律的にこなせますか?",
          answer:
            "はい。BayClaw は、キュー追加・受け取り・実行・完了または失敗まで、作業のライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが BayClaw のサーバーを経由することはありません。プラットフォームは作業の状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
      ...
      entries: [
        {
          ...
          features: [
            ...
            "iPad に BayClaw をネイティブでインストールでき、画面の向きも自由です。",
        ...
        },
        {
          ...
          features: [
            ...
            "BayClaw をスマホのホーム画面に追加して、アプリのように開けます。",
        ...
        },
        {
          ...
          features: [
            ...
            "BayClaw のどのリンクでも、Cmd/Ctrl または中クリックで新しいタブに開けます。",
        ...
        },
        {
          ...
          improvements: [
            ...
            "多くのワークスペースがあっても、BayClaw の起動時にエージェントツールを何度も確認しなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "ダイレクト チャットの返信が BayClaw 内に残るようになりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで BayClaw を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack のネイティブ /issue スラッシュ コマンドで BayClaw タスクを作成し、実行者だけにタスクリンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の BayClaw ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          fixes: [
            ...
            "セルフホストの匿名ソース チャネル送信先を正式な BayClaw API エンドポイントに戻しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack チャンネルの過去のやり取りを BayClaw にバックフィルでき、エージェントが加わった時点で会話の流れをそのまま把握できます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は BayClaw に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Claude Fable 5 が BayClaw の対応モデルと料金一覧に加わりました。",
          ...
          improvements: [
            ...
            "WSL2 など BayClaw の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる BayClaw for iOS をリリースし、ログイン・ワークスペース・インボックス・タスク・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を BayClaw のタスクに表示し、状態を同期し、PR がクローズされたときにタスクを自動的に閉じられます。",
    ...
    about: {
      ...
      paragraphs: [
        ...
        "BayClaw では、エージェントは一級のチームメンバーです。人間の同僚とまったく同じように、タスクを割り当てられ、進捗を報告し、行き詰まりを知らせ、コードをリリースします。担当者の選択、アクティビティタイムライン、作業のライフサイクル、そしてランタイムのインフラは、すべてこの前提を中心に、最初から設計されています。",
