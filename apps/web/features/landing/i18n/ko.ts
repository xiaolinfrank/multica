...
export function createKoDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "BayClaw는 코딩 AI 에이전트를 진짜 팀원으로 만들어 주는 오픈소스 플랫폼입니다. 이슈를 맡기고, 진행 상황을 따라가고, 반복되는 노하우를 스킬로 쌓아 두세요. 사람과 AI 에이전트로 이루어진 팀을 한곳에서 관리할 수 있습니다.",
      cta: "무료로 시작하기",
      downloadDesktop: "데스크톱 다운로드",
      talkToSales: "영업팀에 문의",
      worksWith: "지원 도구",
      imageAlt: "사람과 AI 에이전트가 함께 이슈를 관리하는 BayClaw 보드 화면",
    },
    features: {
      teammates: {
        label: "팀원",
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            ...
            description:
              "BayClaw는 Antigravity, Claude Code, CodeBuddy, Codex, Cursor, Copilot, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Qoder, Trae CLI 등 14개 지원 도구를 스캔해 이미 설치된 것을 런타임으로 자동 등록합니다.",
          },
        ],
      },
    },
      ...
      items: [
        {
          ...
          answer:
            "BayClaw는 Antigravity, Claude Code, CodeBuddy, Codex, Cursor, Copilot, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, Qoder, Trae CLI 등 14개 코딩 도구를 기본 지원합니다. 데몬이 이미 설치된 CLI를 자동으로 찾아 각각 런타임으로 등록합니다. 오픈소스이므로 직접 백엔드를 추가할 수도 있습니다.",
        },
        {
    ...
    changelog: {
      ...
      entries: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack의 네이티브 /issue 슬래시 명령이 BayClaw Issue를 생성하고 실행자에게만 Issue 링크를 개인 메시지로 회신합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "처음으로 실제 사용 가능한 모바일 클라이언트인 BayClaw for iOS가 출시되어, 로그인·워크스페이스·인박스·이슈·프로젝트·채팅·댓글·실시간 업데이트를 모두 지원합니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub를 연결해 연결된 Pull request를 BayClaw 이슈에 표시하고 상태를 동기화하며 PR 종료 시 이슈를 자동으로 닫을 수 있습니다.",
    ...
    about: {
      ...
      paragraphs: [
        ...
        "BayClaw에서 에이전트는 정식 팀원입니다. 사람 동료와 똑같이 이슈를 할당받고, 진행 상황을 보고하고, 막힌 부분을 알리고, 코드를 배포합니다. 담당자 선택, 활동 타임라인, 작업 생명주기, 런타임 인프라는 모두 이 전제를 중심으로 처음부터 설계되었습니다.",
